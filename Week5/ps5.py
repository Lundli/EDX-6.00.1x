...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        alle = string.ascii_lowercase + string.ascii_uppercase
        temp = string.ascii_lowercase
        temp2 = string.ascii_uppercase

        shifted_value = shift
        val = temp[shifted_value:] + temp[:shifted_value] + temp2[shifted_value:] + temp2[:shifted_value]

        dict = {}
        dict = dict.fromkeys(alle, 0)
        n = 0
        for letter in dict:
            dict[alle[n]] = val[n]
            n += 1
...
print("Example test case (PlaintextMessage)")
...
print("Example test case (CiphertextMessage)")
...
print("----------------")
def decrypt_story():
    s = CiphertextMessage(get_story_string())
    return s.decrypt_message()
